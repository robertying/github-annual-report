...
// ====================================================
// GraphQL fragment: CommitSummary
// ====================================================

export interface CommitSummary_contributionCalendar_weeks_contributionDays {
  __typename: "ContributionCalendarDay";
  /**
   * How many contributions were made by the user on this day.
   */
...
export interface CommitSummary_contributionCalendar_weeks {
  __typename: "ContributionCalendarWeek";
  /**
   * The days of contributions in this week.
   */
  contributionDays: CommitSummary_contributionCalendar_weeks_contributionDays[];
}

export interface CommitSummary_contributionCalendar {
  __typename: "ContributionCalendar";
  /**
   * The count of total contributions in the calendar.
   */
   ...
   * A list of the weeks of contributions in this calendar.
   */
  weeks: CommitSummary_contributionCalendar_weeks[];
}
...
export interface CommitSummary {
   ...
   * A calendar of this user's contributions on GitHub.
   */
  contributionCalendar: CommitSummary_contributionCalendar;
}
